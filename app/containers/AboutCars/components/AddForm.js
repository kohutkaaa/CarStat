      ...
      {editTrue === true ? (
          state.carForEditing &&
            <div className="col-12">
              <div className="card my-4 me-4 pt-2">
                        ...
                        <ul className="list-unstyled">
                          ...
                          <li className="mb-2 pt-1">
                            ...
                            <input 
                              ...
                              className="form-control mt-2" 
                              id="defaultFormControlInput" 
                              defaultValue={state.carForEditing.attributes.Transmission} 
                              placeholder={state.carForEditing.attributes.Transmission} 
                              aria-describedby="defaultFormControlHelp"
                              name='Transmission'
                              onChange={(e) => {
                                setDataEditCar(e.target.name, e.target.value)
                          ...
                          <li className="mb-2 pt-1">
                            ...
                            <input 
                              ...
                              className="form-control mt-2" 
                              id="defaultFormControlInput" 
                              defaultValue={state.carForEditing.attributes.Mileage}  
...
function mapDispatchToProps(dispatch) {
  return {
    setDataNewCar: ( key, value ) => { dispatch(setDataNewCar( key, value )) },
    addNewCar: () => { dispatch(addNewCar()) },
    editCar: ( id ) => { dispatch(editCar( id )) },
    setDataEditCar: (key, value) => { dispatch(setDataEditCar(key, value)) },
  };
}
