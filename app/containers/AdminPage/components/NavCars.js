...
function NavCars({ saveCar, saveCarShow, carModel, cars }) {
  ...
  return cars === false ? (
    ...
    <div className="card mt-4 me-4">
      <div className="card-body">
        <ul
          className="nav nav-tabs widget-nav-tabs pb-1 gap-4 mx-1 d-flex flex-nowrap"
          role="tablist"
        >
          <li
            ...
            cars.map((item, index) => (
              <li className="nav-item" role="presentation" key={index}>
                <button
                  ...
                  onClick={() => {
                    saveCar(item.id), saveCarShow(item.attributes);
                  }}
                >
...
export default compose(memo)(NavCars);
