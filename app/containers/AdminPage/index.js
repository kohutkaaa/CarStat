      ...
      <div className="col-9">
        <div>
          ...
          <h6 className="mt-4 text-center text-uppercase text-muted">
            Цей додаток створений, щоб допомогти контролювати витрати на
            автомобіль.
            <br />
            Він дає вам можливість легко і зручно вести статистику своїх витрат.
          </h6>
                        ...
                        <div className="card-body">
                          ...
                          <ul className="px-0 text-center">
                            <span className="text-muted py-1">
                              Допомагає керувати фінансами та знаходити способи
                              економії.
                            </span>
                          </ul>
                        </div>
                        ...
                        <div className="card-body">
                          <div className="d-flex align-items-center mb-2">
                            <span className="badge bg-label-info p-2 rounded me-2">
                              <i className="ti ti-device-laptop ti-sm" />
                            </span>
                            <h5 className="fw-semibold mt-3 ms-1">
                              Зручний доступ:{' '}
                            </h5>
                          ...
                          <ul className="px-0 text-center">
                            <span className="text-muted py-1">
                              Легко переглядати історію витрат та отримувати
                              потрібну інформацію.
                            </span>
                          </ul>
                        </div>
                    ...
                    <div className="col-md-4 col-sm-6 mb-4">
                      <div className="card">
                        <div className="card-body">
                          ...
                          <ul className="px-0 text-center">
                            <span className="text-muted py-1">
                              Ведення статистики витрат на декілька авто
                              одночасно.
                            </span>
                          </ul>
                        </div>
                        ...
                        <div className="card-body">
                          <div className="d-flex align-items-center mb-2">
                            <span className="badge bg-label-warning p-2 rounded me-2">
                              <i className="ti ti-chart-line ti-sm" />
                            </span>
                            <h5 className="fw-semibold mt-3 ms-1">
                              Спільна статистика:{' '}
                            </h5>
                          ...
                          <ul className="px-0 text-center">
                            <span className="text-muted py-1">
                              Перегляд загальної статистики витрат на всі
                              автомобілі.
                            </span>
                          </ul>
                        </div>
                    ...
                    <div className="col-md-4 col-sm-6 mb-4">
                      <div className="card">
                        <div className="card-body">
                          ...
                          <ul className="px-0 text-center">
                            <span className="text-muted py-1">
                              Отримання нагадувань про регулярні витрати, такі
                              як страховка.
                            </span>
                          </ul>
                        </div>
                        ...
                        <div className="card-body">
                          <div className="d-flex align-items-center mb-2">
                            <span className="badge bg-label-danger p-2 rounded me-2">
                              <i className="ti ti-businessplan ti-sm" />
                            </span>
                            <h5 className="fw-semibold mt-3 ms-1">
                              Організація витрат:{' '}
                            </h5>
                          ...
                          <ul className="px-0 text-center">
                            <span className="text-muted py-1">
                              Зручно організовувати і категоризувати витрати на
                              авто.
                            </span>
                          </ul>
                        </div>
